...
public class ViewMsg extends Activity {
...
//		AlertDialogBox();
		...
		{
			aController.showAlertDialog(ViewMsg.this,"Internet Connection Error","Please connect to Internet connection", false);
...
//                               input.getText().toString();
        	                     ...
        	                     try 
        	                     {
        	                       ...
        	                       //normalTextEnc = Encryptor.encrypt(seedValue, message1);
								    ...
								    Toast.makeText(getApplicationContext(), "Key Matched", Toast.LENGTH_SHORT).show();
                                     ...
                                     txtMessage.setText(normalTextDec);
                               ...
                               } else 
                               {
                                    ...
                                    txtMessage.setText("Msg Not decrypted Try Again !!!");
                                    txtMessage.setFocusable(false);
...
//		 alertDialog.show();	
    	...
    	public void onClick(DialogInterface dialog, int whichButton)
    	{
         ...
         {
           Toast.makeText(getApplicationContext(), "Key Matched", Toast.LENGTH_SHORT).show();
              Intent myIntent1 = new Intent(getApplicationContext(),ViewMsg.class);
             startActivity(myIntent1);
	...
	public class LongOperation  extends AsyncTask<String, Void, String> 
	{
        ...
        private ProgressDialog Dialog = new ProgressDialog(ViewMsg.this); 
        String data  = ""; 
        int sizeData = 0;  
